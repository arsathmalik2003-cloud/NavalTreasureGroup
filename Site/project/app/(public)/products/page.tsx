...
export default function ProductsPage() {
  ...
  const allProducts = [
    ...
    },
    {
      ...
      category: 'meat',
      tag: 'Meat Products',
      desc: 'Premium-quality beef sourced from carefully selected livestock and hygienically processed to preserve its natural flavor, tenderness, freshness, and quality. Suitable for retail, wholesale, food service, and international meat markets.',
      specs: ['Export Grade', 'Quality Selected', 'Hygienically Processed', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'meat',
      tag: 'Meat Products',
      desc: 'Premium-quality lamb sourced from carefully selected livestock and hygienically processed to preserve its natural flavor, tenderness, freshness, and quality. Suitable for retail, wholesale, food service, and international meat markets.',
      specs: ['Export Grade', 'Quality Selected', 'Hygienically Processed', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'vegetable_powder',
      tag: 'Dehydrated Vegetable Powders',
      desc: 'Premium dehydrated garlic powder produced from carefully selected fresh garlic and processed under controlled conditions to preserve its natural aroma, pungent flavor, nutritional value, and quality. Suitable for food manufacturing, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'vegetable_powder',
      tag: 'Dehydrated Vegetable Powders',
      desc: 'Premium dehydrated onion powder produced from carefully selected fresh onions and processed under controlled conditions to preserve its natural aroma, savory flavor, nutritional value, and quality. Suitable for food manufacturing, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'vegetable_powder',
      tag: 'Dehydrated Vegetable Powders',
      desc: 'Premium dehydrated spinach powder produced from carefully selected fresh spinach leaves and processed under controlled conditions to preserve its natural green color, mild flavor, nutritional value, and quality. Suitable for food manufacturing, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'vegetable_powder',
      tag: 'Dehydrated Vegetable Powders',
      desc: 'Premium dehydrated ginger powder produced from carefully selected fresh ginger and processed under controlled conditions to preserve its natural aroma, warm flavor, nutritional value, and quality. Suitable for food manufacturing, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'vegetable_powder',
      tag: 'Dehydrated Vegetable Powders',
      desc: 'Premium dehydrated moringa leaf powder produced from carefully selected fresh moringa leaves and processed under controlled conditions to preserve their natural green color, earthy flavor, nutritional value, and quality. Suitable for food manufacturing, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'fruit_powder',
      tag: 'Dehydrated Fruit Powders',
      desc: 'Premium dehydrated mango powder produced from carefully selected fresh, ripe mangoes and processed under controlled conditions to preserve their natural aroma, vibrant color, rich tropical flavor, nutritional value, and quality. Suitable for food manufacturing, beverages, bakery and confectionery products, seasoning blends, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Natural Fruit Flavor', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'fruit_powder',
      tag: 'Dehydrated Fruit Powders',
      desc: 'Premium dehydrated pineapple powder produced from carefully selected fresh, ripe pineapples and processed under controlled conditions to preserve their natural aroma, refreshing tropical flavor, vibrant color, nutritional value, and quality. Suitable for food manufacturing, beverages, bakery and confectionery products, desserts, seasoning blends, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Natural Fruit Flavor', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'fruit_powder',
      tag: 'Dehydrated Fruit Powders',
      desc: 'Premium dehydrated papaya powder produced from carefully selected fresh, ripe papayas and processed under controlled conditions to preserve their natural aroma, smooth tropical flavor, vibrant color, nutritional value, and quality. Suitable for food manufacturing, beverages, bakery and confectionery products, desserts, nutritional blends, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Natural Fruit Flavor', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'fruit_powder',
      tag: 'Dehydrated Fruit Powders',
      desc: 'Premium dehydrated pomegranate powder produced from carefully selected fresh, ripe pomegranates and processed under controlled conditions to preserve their natural aroma, distinctive tangy-sweet flavor, rich color, nutritional value, and quality. Suitable for food manufacturing, beverages, bakery and confectionery products, nutritional blends, seasoning applications, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Natural Fruit Flavor', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'fruit_powder',
      tag: 'Dehydrated Fruit Powders',
      desc: 'Premium dehydrated guava powder produced from carefully selected fresh, ripe guavas and processed under controlled conditions to preserve their natural aroma, distinctive tropical flavor, vibrant color, nutritional value, and quality. Suitable for food manufacturing, beverages, bakery and confectionery products, desserts, nutritional blends, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Natural Fruit Flavor', 'Custom Packaging'],
    ...
    },
    {
      ...
      category: 'fruit_powder',
      tag: 'Dehydrated Fruit Powders',
      desc: 'Premium dehydrated grape powder produced from carefully selected fresh, ripe grapes and processed under controlled conditions to preserve their natural aroma, rich fruity flavor, natural color, nutritional value, and quality. Suitable for food manufacturing, beverages, bakery and confectionery products, dessert mixes, nutritional blends, retail, wholesale, and international export markets.',
      specs: ['Export Grade', 'Food Grade', 'Moisture Controlled', 'Natural Fruit Flavor', 'Custom Packaging'],
