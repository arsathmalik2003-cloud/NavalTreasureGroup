        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-base md:text-lg text-[#52525b] leading-relaxed">
              Naval Treasure Group International Sdn Bhd is an international food products sourcing and trading company focused on connecting quality seafood, meat, and dehydrated powders with global markets.
            </p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10 pb-8 border-b border-[#ececee]">
              ...
              <div className="inline-flex p-1.5 bg-[#f4f4f5] rounded-[10000px] border border-[#ececee]">
                <button
                  ...
                  className={`px-5 py-2.5 rounded-[10000px] text-xs font-bold transition-all ${
                    activeTab === 'sustainability'
